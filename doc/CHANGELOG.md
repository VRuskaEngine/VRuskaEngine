# Changelog for VRuska Engine {#CHANGELOG}

<!--
SPDX-License-Identifier: CC0-1.0

SPDX-FileCopyrightText: 2020-2025 Collabora, Ltd. and the VRuska Engine contributors
-->
...
- Misc. Fixes
  ...
  - Fix: Vulkan-related crashes, Vulkan validation errors, and other Vulkan API
    usage issues.
    ([!2316](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2316),
...
- Major changes
  ...
  - Added WinMR driver, it supports most headsets and controllers. Controllers can
    ...
    [!1845](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1845),
  ...
  - Add framework support for face tracking xrt-devices. XR_HTC_facial_tracking
    ...
    ([!2163](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2163),
...
- XRT Interface
  ...
  - Add `xrt_device::ref_space_usage` function to let an `xrt_device` know if a
    ...
    [!2107](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2107))
...
- State Trackers
  ...
  - OpenXR: Fix unhandled enum in switch statements.
    ([!2069](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2069),
...
- Drivers
  ...
  - ohmd: Support OpenHMD controllers and specifically the Oculus Touch controller.
    ([!742](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/742))
  - ohmd: Fix warnings and tidy.
    ([!2038](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2038))
  - ohmd: Disable WMR and Rift S drivers with a warning to use the native
    drivers.
    ([!2221](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2221))
  - opengloves: Refactor creation.
    ([!1987](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1987))
  - pssense: Add trigger force feedback.
    ([!1916](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1916))
  - psvr: Ensure that timestamps are always monotonic, stopping any time-traveling
    sample packets.
    ([!717](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/717))
  - qwerty: Add qwerty driver for emulating headset and controllers with mouse and
    keyboard.
    ([!714](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/714),
    [!1789](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1789),
    [!1926](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1926))
  - qwerty: Fix input timestamps for select and menu.
    ([!2080](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2080))
  - realsense: Expand driver to support non-T26x cameras and external SLAM
    tracking.
    ([!907](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/907))
  ...
  - remote: Fix socket closing on Windows by using socket_close.
    ([!2060](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2060),
    [!2061](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2061))
  - rift_s: Add Rift-S driver, this works with VRuska Engine's hand and SLAM tracking.
    ([!1447](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1447),
    [!1580](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1580),
    [!1665](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1665),
    [!1691](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1691),
    [!1823](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1823))
  ...
  - steamvr_lh: Add driver that wraps the SteamVR Lighthouse driver.
    ([!1861](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1861),
    [!1927](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1927),
    [!1943](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1943),
    [!1947](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1947),
    [!1950](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1950),
    [!2077](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2077),
    [!2090](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2090))
  ...
  - steamvr_lh: Fix warnings with logger defines.
    ([!1929](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1929))
  ...
  - steamvr_lh: Add a mutex to update_inputs() to prevent unsafe condition in
    lighthouse driver.
    ([!1968](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1968))
  - steamvr_lh: Add tundra as a generic tracker
    ([!1979](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1979))
  - steamvr_lh: Silence some useless logging and properly wait for vive wands to
    settle
    ([!1986](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1986))
  ...
  - steamvr_lh: Make playspace reading more robust by choosing the first tracking
    ...
    ([!2114](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2114))
  - steamvr_lh: Add additional bindings for vive and index controllers.
    ([!2115](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2115))
  - steamvr_lh: Introduce new driver interface
    ([!2136](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2136),
    [!2213](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2213))
  - steamvr_lh: Adjust location flags behavior for better lighthouse tracking on
    occlusion
    ([!2212](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2212))
  - survive: Add support for Gen 3.0 and Tundra trackers.
    ([!1860](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1860))
  - survive: Add support for HTC Vive Pro 2
    ([!1911](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1911))
  - survive: Fall back to default ipd if survive reports 0.0
    ([!2128](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2128))
  - survive/vive: Use new common controller bindings in `a/vive`.
    ([!1265](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1265))
  - ulv5: Add orientation values to hand joints.
    ([!2118](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2118))
  ...
  - vf: Some tidy, frame fixes and tracing support.
    ([!860](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/860))
  - vive: Factor out json config parser and reuse it in survive driver.
    ([!674](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/674))
  - vive: Add rotation pose prediction to HMD and Controllers
    ([!691](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/691))
  - vive: Setup the variable tracking for imu fusion.
    ([!740](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/740))
  - vive: Tidy code by improving comments, removing old print, and use defines for
    hardcoded values.
    ([!793](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/793))
  ...
  - vive: Drian IMU packets at start, this helps reduce time drift due backed up
    ...
    ([!1829](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1829))
  ...
  - vive: Add support for Gen 3.0 and Tundra trackers.
    ([!1860](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1860),
    [!1860](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1860),
    [!1863](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1863))
  - vive: Try to set realtime priority on sensors thread
    ([!1881](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1881))
  - vive: Set the correct tracking origin type when we have SLAM.
    ([!1893](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1893))
  ...
  - wmr: Add Windows Mixed Reality driver, supports 6dof through Basalt.
    ([!774](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/774),
    [!803](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/803),
    [!1796](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1796),
    [!1797](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1797))
  ...
  - wmr: Improve WMR controller orientation when in 3DoF by using the information
    ...
    ([!1858](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1858))
  - wmr: Reduce drifting by applying calibration biases to controllers, doesn't
    ...
    ([!1876](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1876))
  ...
  - wmr: Add `WMR_LEFT_DISPLAY_VIEW_Y_OFFSET` and `WMR_RIGHT_DISPLAY_VIEW_Y_OFFSET`
    ...
    ([!1988](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1988))
  - wmr: Add Dell Visor support to WMR driver.
    ([!2023](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2023))
  - wmr: Follow common naming of update_inputs.
    ([!2038](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2038))
  - wmr: Add support for Acer AH101 HMD
    ([!2222](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2222))
- IPC
  - Add support for thread hint function.
    ([!1951](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1951))
  - Android: Do not require OPENXR permission when connecting to VRuska EngineService.
    Permission will not be granted if install application before permission
    container.
    ([!1213](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1213))
  - all: Use `libbsd` pidfile to detect running VRuska Engine instances. Enables
    automatically deleting stale socket files. The socket file is now placed in
    `$XDG_RUNTIME_DIR/VRuska Engine_comp_ipc` by default or falls back to
    `/tmp/VRuska Engine_comp_ipc` again if `$XDG_RUNTIME_DIR` is not set.
    ([!565](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/565))
  - all: Transfer HMD blend mode, don't drop it on the floor.
    ([!694](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/694))
  - all: Now that there is a interface that allows the compositor to support
    ...
    [!768](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/768),
    [!800](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/800),
    [!846](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/846))
  ...
  - all: Add Windows support to the IPC layer, this is based on named pipes.
    ([!1525](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1525),
    [!1531](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1531),
    [!1584](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1584),
    [!1807](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1807))
  ...
  - all: Rename client connected function and document code.
    ([!1909](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1909))
  ...
  - all: Add support for dynamic device roles.
    ([!1992](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1992),
    [!2013](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2013))
  - all: Add ability to do more complex IPC communication by introducing VLA
    ...
    ([!2009](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2009),
    [!2009](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2009),
    [!2053](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2053))
  ...
  - all: Share per client thread shutdown code between platforms.
    ([!2046](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2046))
  ...
  - all: Add support for the new `xrt_system` and `xrt_session` objects.
    ([!2062](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2062),
    [!2079](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2079),
    [!2095](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2095))
  ...
  - android: Dup the fd from JVM and maintain it in native.
    ([!1924](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1924))
  - client: Refactor out the connection connect code into a its own file, this lets
    it be reused by other things that might want to connect like VRuska Engine-ctl and
    libVRuska Engine.
    ([!1875](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1875))
  - client: Destroy the shared memory area when shutting down.
    ([!1906](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1906))
  - client: Add a interface header for `ipc_instance_create`.
    ([!1917](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1917))
  - client: Generate limited unique ids for native swapchains.
    ([!1957](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1957))
  - client: Refactor connection init code.
    ([!2011](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2011))
  - client: Check git tag as early as possible when connecting.
    ([!2011](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2011))
  - client: Use `log_level` from the message channel.
    ([!2022](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2022))
  - client: Add and use return check helpers, this makes it easier to see where the
    error happened.
    ([!2025](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2025),
    [!2025](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2025),
    [!2028](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2028))
  ...
  - server: Factor out the IPC server mainloop into a per-platform structure.
    ([!685](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/685))
  ...
  - server: Fix session deactivation negative array index access.
    ([!1991](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1991))
  - server: Use macro TEMP_FAILURE_RETRY to avoid closing a client connection on
    `-ENTR`.
    ([!2007](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2007),
    [!2012](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2012))
  ...
  - server: Re-order functions [NFC]
    ([!2096](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2096))
  - server: Add "XRT_NO_STDIN" option disables stdin and prevents VRuska Engine-service
    from terminating.
    ([!2133](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2133))
  ...
  - shared: Minor fixes and tidy ipc_generated_protocol.h file.
    ([!2030](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2030))
  - shared: Add ipc_command_size function to the protocol generation.
    ([!2053](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2053))
- Compositor
  - Android: Refactor surface creation flow.
    ([!1742](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1742))
  ...
  - android: Default to compute compositor to work around issue
    [381](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/-/issues/381).
    ([!2236](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2236))
  ...
  - client: Use the EGL compositor's display in swapchain, previously it tried to
    ...
    ([!827](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/827))
  - client: Initial support for D3D11 client applications on Windows.
    ([!943](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/943),
    [!1263](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1263),
    [!1295](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1295),
    [!1326](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1326),
    [!1302](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1302),
    [!1337](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1337),
    [!1340](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1340))
  - client: Wait on Vulkan clients to complete rendering.
    ([!1117](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1117))
  - client: Set default log level on vk_bundle in Vulkan compositor.
    ([!1142](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1142))
  ...
  - client: Support for OpenGL client applications on Windows.
    ([!1465](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1465))
  - client: Reduce the minimum required OpenGL version for client applications to
    3.0.
    ([!1465](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1465),
    [#47](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/issues/47))
  - client: Do not use the global command buffer pool in the Vulkan compositor.
    ([!1748](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1748))
  - client: Silence VK_FORMAT_R32_SFLOAT warning in OpenGL code.
    ([!1750](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1750))
  - client: Don't use vkDeviceWaitIdle, because it requires all queues to be
    externally synchronized which we can't enforce.
    ([!1751](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1751))
  ...
  - client: Wait till D3D12 images aren't in use before releasing the swapchain.
    ([!1868](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1868))
  - client: Use D3D12 allocator, and work around NVIDIA bug.
    ([!1920](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1920))
  - client: Make sure to not double CloseHandle semaphore HANDLE.
    ([!1935](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1935))
  - client: Expose size limit for swapchains.
    ([!1964](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1964),
    [!2066](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2066))
  - client: Add and use helpers to unwrap native swapchains and compositors.
    ([!1982](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1982))
  - client: Make it possible to set log level in Vulkan compositor.
    ([!1993](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1993))
  ...
  - client: Run D3D12 swapchain initial barriers after all possible points of
    failure.
    ([!2161](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2161))
  - client/util: Fix several flags being set wrong on barriers and creation of the
    ...
    ([!1119](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1119),
    [!1124](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1124),
    [!1125](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1125),
    [!1128](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1128))
  - comp: Fix layer submission on NVIDIA Tegra.
    ([!677](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/677))
  ...
  - main: Make it possible to create the swapchain later when actually needed,
    ...
    ([!767](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/767),
    [#120](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/issues/120),
    [!787](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/787))
  - main: Do not list VK_FORMAT_A2B10G10R10_UNORM_PACK32 as a supported format,
    ...
    ([!833](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/833))
  - main: Also resize on VK_SUBOPTIMAL_KHR.
    ([!841](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/841))
  - main: Increase the usage of the `get_vk` helper function.
    ([!967](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/967))
  ...
  - main: Add support for mirroring the left view back to the debug gui, so we can
    ...
    ([!1120](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1120),
    [!1135](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1135),
    [!1144](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1144))
  - main: Use at least 3 Vulkan images for comp_target_swapchain if supported.
    ([!1268](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1268))
  ...
  - main: Refactor comp_target_swapchain to not pre-declare internal functions, we
    ...
    ([!1269](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1269))
  - main: Make `VK_KHR_external_[fence|semaphore]_fd` optional, this is helpful for
    ...
    ([!1270](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1270))
  - main: Add thread waiting for vblank events, lets the fake pacer properly
    synchronise with hardware.
    ([!1271](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1271))
  - main: Init comp_base as early as possible, because it needs to be finalised
    ...
    ([!1316](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1316))
  - main: Propagate more errors from the renderer frame drawing and helper mirror
    functions.
    ([!1417](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1417))
  ...
  - main: Introduce `comp_target_factory`. This struct allows us to remove long and
    ...
    ([!1570](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1570),
    [!1684](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1684))
  - main: Refactor arguments to `comp_target_create_images`, introduces the struct
    `comp_target_create_images_info`.
    ([!1601](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1601))
  ...
  - main: Refactor to use vk_surface_info helper.
    ([!1801](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1801))
  - main: Refactor frame handling, makes semantics clearer.
    ([!1801](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1801),
    [!1801](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1801),
    [!1820](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1820))
  ...
  - main: Use the new samplers on render_resources, remove the layer renderer
    ...
    ([!1824](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1824))
  - main: Optionally enable VK_EXT_debug_marker extension on debug builds.
    ([!1877](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1877))
  - main: Name all fence objects using debug helper function.
    ([!1877](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1877))
  - main: Use vk_cmd_submit_locked in vk_helper to simply peek logic
    ([!1884](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1884))
  ...
  - main: Use enumeration helpers in and refactor the NVIDIA direct target code.
    ([!1894](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1894),
    [!1894](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1894),
    [!1913](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1913))
  ...
  - main: Use more enumeration helpers.
    ([!1940](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1940))
  ...
  - main: Use new layer squasher helpers and manage scratch images lifetime.
    ([!1955](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1955))
  - main: Trace mirror blit function.
    ([!1957](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1957))
  - main: Name the runtime Surface on Android.
    ([!1963](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1963))
  - main: Refactor the layer rendering code to use `render_gfx_render_pass`,
    ...
    ([!1969](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1969),
    [!1969](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1969),
    [!1970](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1970))
  - main: Use VK_CHK_WITH_RET instead of vk_check_error, and convert a few other
    places to the helpers as well.
    ([!1971](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1971),
    [!2050](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2050))
  - main: Tidy headers in layer renderer.
    ([!1974](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1974))
  ...
  - main: Wire up timewarp on the graphics path for the distortion shaders.
    ([!1981](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1981))
  ...
  - main: Add argument to specify display mode id for surface creation.
    ([!2010](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2010))
  ...
  - main: Add enum to select FoV source, it was very unclear where exactly the FoV
    ...
    accessed from.
    ([!2101](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2101))
  - main: Use new debuggable scratch images (one `comp_scratch_single_images` per
    ...
    ([!2103](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2103))
  - main: Use vk_enumerate_swapchain_images helper.
    ([!2104](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2104))
  - main: Improve swapchain creation to print more debug information.
    ([!2104](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2104))
  - main: Split submit timing into begin and end.
    ([!2108](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2108))
  - main: Make sure to not use the array of displays if we fail to allocate it, and
    also tidy the code.
    ([!2113](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2113))
  ...
  - main: let compositor targets control more of vulkan initialization.
    ([!2134](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2134),
    [!2179](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2179))
  - main: Fix bug with incorrect surface format matching.
    ([!2183](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2183))
  - multi: Introduce a new multi client compositor layer, this allows rendering
    ...
    [!754](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/754),
    [!759](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/759),
    [!1323](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1323),
    [!1346](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1346),
    [#171](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/issues/171))
  - multi: Make sure there are at least some predicted data, to avoid asserts in
    non-service mode.
    ([!864](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/864))
  ...
  - multi_layer_entry: Updated the array length of xscs within multi_layer_entry
    ...
    ([!2086](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2086),
    [!2175](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2175),
    [!2189](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2189))
  - null: Add a new compositor intended to be used on CIs that use the Mesa
    ...
    ([!1319](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1319))
  ...
  - render: Refactor and reorganize compositor to improve modularity and ease of
    ...
    ([!959](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/959),
    [!959](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/959),
    [!967](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/967),
    [!970](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/970),
    [!982](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/982),
    [!1021](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1021))
  ...
  - render: Reuse a single command buffer instead of allocating/freeing it every
    frame.
    ([!1352](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1352))
  ...
  - render: Stop timewarp stretching by changing math.
    ([!1956](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1956))
  ...
  - render: Use defines helpers from Vulkan helper code instead of defining self.
    ([!1972](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1972))
  ...
  - render: Add ability to sub-allocate UBOs from a larger buffer, both code and
    ...
    ([!1976](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1976))
  - render: Make gfx mesh distortion shader sub-allocate it's UBO.
    ([!1976](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1976))
  - render: Refactor gfx mesh shader allocation and dispatch.
    ([!1980](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1980))
  ...
  - util: Completely propagate errors from image creation failures and some tidy.
    ([!1417](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1417),
    [!1417](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1417),
    [!2052](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2052))
  ...
  - util: Improve Vulkan instance creation code to be clearer about what extensions
    ...
    ([!1885](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1885))
  - util: Make sure to not destroy invalid `VkSemaphore` objects.
    ([!1887](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1887))
  - util: Track native semaphore handles, following the semantics of other handles
    in VRuska Engine. This fixes the leak of `syncobj_file` on Linux.
    ([!1887](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1887))
  ...
  - util: Add helpers to launch the compute layer squasher shaders and the compute
    ...
    ([!1955](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1955),
    [!1955](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1955),
    [!1967](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1967),
    [!1975](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1975))
  ...
  - util: Expand on swapchain import error codes. This allows the CTS in Direct3D
    ...
    ([!2167](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2167))
  - util: Fix double free when failing to initialize Vulkan swapchain
    ...
    ([!2199](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2199))
  - util: Fix vk_deinit_mutex asserts when vk_create_device fails.
    ([!2214](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2214))
  - util: Fix a crash bug in `render_gfx_end_target` with non-compute pipeline path
    ...
    ([!2216](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2216))
...
- Tracking
  ...
  - mercury: Add Levenberg-Marquardt optimizer and lots of improvements. Makes hand
    ...
    ([!1381](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1381))
...
- Helper Libraries
  - Introduce VIT loader to load a given VIT system, implement the VIT interface in
    ...
    feature on Linux.
    ([!2058](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2058),
    [!2125](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2125),
    [!2144](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2144))
  - When a space is located in itself as base space, skip locating the space
    altogether.
    ([!2192](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2192))
  ...
  - a/util: Fix missing lib in cmake file for building `mercury_steamvr_driver`
    ([!2169](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2169))
  - a/vive: Add FoV tweaks for another index HMD
    ([!1937](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1937))
  - all: Rename all `num_` parameters and fields, typically to `_count`, to match
    OpenXR convention.
    ([!977](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/977))
  ...
  - aux/debug_ui: bump the minimum gl version to 4.5
    ([!2147](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2147))
  ...
  - bindings: Add OPPO MR controller profile.
    ([!1904](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1904))
  - bindings: Replaces the `VRuska Engine_device` entry for `XR_EXT_hand_interaction` in
  ...
  - cmake: Split the CMakeLists.txt out into the sub-directories of each library,
    ...
    ([!1328](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1328))
  - d3d: Add D3D helpers used by various parts of VRuska Engine, mostly the D3D11 client
    compositor.
    ([!943](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/943),
    [!1326](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1326),
    [!1302](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1302),
  ...
  - math: Minor tidy of `m_api.h`, `m_base.cpp` and `CMakeLists.txt`.
    ([!1978](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1978))
  ...
  - math: Refactor m_clock_offset_a2b to avoid precision problems.
    ([!2106](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2106))
  - math: Refactor apply_relation to handle valid/tracked flags more like OpenXR.
    ([!2186](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2186))
  - math: Restore upgrading of 3DOF relations with valid positions to ensure 3DOF
    devices have VRuska Engine's 3DOF offset.
    ([!2239](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2239))
  ...
  - os: Rename threading functions to more clearly state that it both stops and
    ...
    initialized.
    ([!1320](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1320),
    [!1324](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1324),
    [!1329](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1329),
    [!1353](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1353))
  - os/threading: Add mutex recursive wrapper.
    ([!1933](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1933))
  - os/threading: fix assert in debug build
    ([!2127](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2127))
  - os/time: Use timePeriod[Begin|End] when sleeping in precise sleeper
    ([!1585](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1585))
  - pacing: Add minimum app margin, also add `U_PACING_APP_MIN_MARGIN_MS` env var.
    ([!1961](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1961))
  - system_helpers: Make system devices easier to embed.
    ([!1977](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1977))
  ...
  - t/calibration: Add support for findChessboardCornersSB in calibration code.
    ([!911](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/911))
  - t/cli: Add VRuska Engine-cli slambatch command for evaluation of SLAM datasets in
    batch.
    ([!1172](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1172))
  - t/euroc: Add EuRoC dataset recorder for saving camera and IMU streams to disk.
    ([!1017](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1017))
  ...
  - t/file: Migrate calibration file format to JSON.
    ([!1005](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1005))
  - t/fm: Add simple FrameMat that wraps a cv::Mat, this allows us to easily pass
    ...
    ([!825](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/825))
  ...
  - t/slam: Initial external SLAM tracking support, working with fork of Kimera-
    VIO.
    ([!889](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/889))
  - t/slam: Add Basalt as a possible external SLAM system.
    ([!941](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/941))
  - t/slam: Update SLAM interface to support dynamically query external systems for
    special features.
    ([!1016](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1016))
  ...
  - t/slam: Add trajectory filters and use IMU for prediction in the SLAM tracker.
    ([!1067](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1067))
  - t/slam: Add tools for performance and accuracy evaluation of the SLAM tracker.
    ([!1152](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1152))
  ...
  - t/slam: Use locks for CSV writers
    ([!2000](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2000))
  - t/slam: Use newly-extracted "VIT" (visual-inertial tracking) interface project,
    version 2.0.1, to connect to SLAM trackers.
    ([!2131](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2131),
    [!2132](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2132))
  - t/slam: Send hand tracking masks to VIT system
    ([!2131](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2131))
  - tracking: Tidy and improve `xrt::auxiliary::tracking::FrameMat`.
    ([!2056](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2056))
  ...
  - u/builder: Introduce new `u_builder` to make it easier to implement the
    ...
    ([!2057](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2057),
    [!2072](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2072))
  ...
  - u/debug: Refactor code to be prettier and expose more conversion functions.
    ([!1874](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1874))
  ...
  - u/fifo: Doc comments, and small improvements to the C++ wrapper helper.
    ([!1810](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1810))
  ...
  - u/file: Changed file open mode from "r" to "rb" to ensure binary mode is used
    ...
    ([!2164](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2164))
  - u/frame_times_widget: Optimize FPS calculation using precomputed frame timings.
    ([!2068](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2068))
  - u/generic_callbacks: Fix missing include for generic callback structure.
    ([!1931](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1931))
  - u/json: Add cJSON C++ wrapper.
    ([!957](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/957))
  ...
  - u/logging: Add logging sink to intercept log messages.
    ([!1171](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1171))
  - u/logging: Log to stderr in Windows.
    ([!1475](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1475))
  - u/logging: Truncate the output of hexdump at a safer limit (16MB).
    ([!1865](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1865),
    [!1879](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1879))
  - u/logging: Refactor printing to be safer using truncating helpers, and increase
    the reuse of code.
    ([!1865](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1865),
    [!1865](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1865),
    [!1892](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1892))
  ...
  - u/logging: Add json logging, it can be enabled via the XRT_JSON_LOG env var.
    ([!1898](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1898))
  - u/metrics: Add code that allows writing various metrics information that can
    ...
    ([!1512](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1512),
    [!1521](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1521),
    [!1579](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1579))
  ...
  - u/pacing: Renames and improvements for frame pacing (formerly known as render
    ...
    ([!1081](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1081),
    [!1104](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1104))
  ...
  - u/pacing: General improvements.
    ([!1809](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1809))
  - u/pacing: Add minimum compositor frame time.
    ([!1809](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1809))
  - u/pacing: Add minimum application frame time.
    ([!1809](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1809),
    [!1809](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1809),
    [!1828](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1828))
  ...
  - u/pacing: Add option U_PACING_APP_USE_MIN_FRAME_PERIOD to allow selecting the
    ...
    ([!2076](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2076),
    [!2084](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2084))
  ...
  - u/trace_marker: Add trace marker support code, this code uses the Linux
    trace_marker kernel support to enable VRuska Engine to trace both function calls and
    other async events.
    ([!697](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/697))
  - u/trace_marker: Switch from homegrown tracing code to using Percetto/Perfetto.
    ([!811](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/811),
    [!840](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/840))
  ...
  - u/truncate_printf: Add helpers that have the semantics we want for the printf
    ...
    ([!1865](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1865),
    [!1865](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1865),
    [!1923](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1923))
  ...
  - u/var: Protect tracker access with a mutex. Solves a race condition that may
    ...
    ([!2177](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2177))
  ...
  - vive: Tidy the files a lot, break the calibration getters out into own file.
    ([!1792](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1792))
  ...
  - vive: Refactor documentation and move VID and PID defines here.
    ([!1862](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1862))
  - vive: Add support for HTC Vive Pro 2
    ([!1911](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1911))
  - vive: Add C++ guards to poses header.
    ([!1929](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1929))
  - vive: Fix use after free, probably left over since refactor.
    ([!1960](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1960))
  - vive: Add builder helper to allow sharing of estimation code.
    ([!2008](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2008))
  ...
  - vk: Refactor bundle functions into a file of their own.
    ([!1203](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1203))
  - vk: Separate printing functions into their own file.
    ([!1203](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1203),
    [!1203](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1203),
    [!1942](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1942))
  ...
  - vk: Relax the compute-only queue search to fall back to any queue that supports
    compute.
    ([!1404](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1404))
  ...
  - vk: Add new cmd buffer helper file `vk_cmd.[h|c]`, these does not use the
    global command pool.
    ([!1766](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1766))
  ...
  - vk: Add function to check required instance extensions.
    ([!1885](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1885),
    [!1885](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1885),
    [!1973](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1973))
  ...
  - vk: Init vk bundle with `shaderImageGatherExtended` enabled if supported.
    ([!1959](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1959))
  ...
  - vk: Change the naming function to use the extension `VK_EXT_debug_utils`, which
    ...
    ([!2006](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2006),
    [!2014](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2014))
  ...
  - vk: Use formats list from `xrt_swapchain_create_info` in `create_image`.
    ([!2049](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2049),
    [!2100](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2100))
  ...
  - vk: Extend command buffer wait timeout to ~10 seconds. This is necessary
    ...
    ([!2205](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2205))
- Documentation
  - Add documentation for how to write changelogs in the conventions page.
    ([!1872](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1872),
    [!2120](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2120))
  - Add documentation category in changelog documentation.
    ([!1878](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1878))
  - Add doxygen-awesome theme
    ([!1883](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1883),
    [!1888](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1888))
  - Don't build documentation by default, it is fairly heavy for end users. Also
    ...
    ([!1891](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1891))
  - README: Add Debian/Ubuntu package for libudev.
    ([!1918](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1918))
  - README: Clarify Vulkan SDK requirement on Windows.
    ([!1919](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1919))
  - README: Add some Debian/Ubuntu packages.
    ([!1923](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1923))
  - comments: Lots of smaller documentation comment fixes.
    ([!1953](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1953),
    [!2037](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2037),
    [!2070](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2070),
    [!2085](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2085))
  - Add page with information for Linux packagers.
    ([!2195](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2195))
  - doc: Add Ubuntu 24.04 as supported OS [NFC]
    ([!2202](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2202))
- Misc. Features
  - Add JSON Schema for config files.
    ([!785](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/785),
    [#82](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/issues/82))
  - Add `cmake-format` config files and `scripts/format-cmake.sh` to keep our build
    system tidy.
    ([!984](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/984),
    [#72](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/issues/72),
    [!1342](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1342))
  - Add Nix flake files so that people that use the nix package manager can have an
    instant VRuska Engine development environment.
    ([!2152](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2152))
  - Android: Update activity and service icons to the new official VRuska Engine logos,
    and use a modified version for in-process builds to indicate they are mainly
    for debugging.
    ([!2208](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2208))
  - For code that is implemented in C++, note that the default standard mode is now
    ...
    ([!809](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/809))
  - Implement tracking overrides using wrapper devices and add a tracking override
    configuration gui.
    ([!695](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/695))
  - In `flake.nix` and `flake.lock`, updates `nixpkgs` to the version where the
    missing dependency was added.
    ([!2184](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2184))
  - Introduce `.mailmap` file.
    ([!2041](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2041))
  ...
  - More improvements to the Android port.
    ([!676](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/676),
    [!703](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/703),
    [!783](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/783),
    [!808](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/808),
    [!817](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/817),
    [!820](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/820),
    [!918](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/918),
    [!920](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/920),
    [!942](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/942),
    [!1020](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1020),
    [!1178](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1178),
    [!1341](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1341),
    [!1357](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1357),
    [!1369](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1369),
    [!1372](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1372),
    [!1377](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1377),
    [!1385](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1385),
    [!2232](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2232),
    [!2204](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2204))
  - More work on the Windows port: fix timing, waiting, sleeping, handling the
    message queue.
    ([!739](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/739),
    [!743](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/743),
    [!1322](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1322))
  - Sign main branch CI-generated APKs for Android release builds.
    ([!2209](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2209))
  - a/gst: Add a small and fairly naive framework for integrating gstreamer
    pipelines into VRuska Engine pipelines. Enough to be able to push frames into it
    and use various encoder elements.
    ([!715](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/715),
    [!1966](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1966))
  - cmake: remove unused ffmpeg dependency
    ([!2122](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2122))
  - cmake: enable policy CMP0083 for position-independent-executable support
    ([!2168](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2168),
    [#337](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/issues/337))
  - cmake: add VERSION and SOVERSION properties to VRuska Engine shared library
    ([!2170](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2170))
  - ext/imgui: Add helper to draw a image/texture with a cleared background color.
    ([!1957](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1957))
  - ext/openxr: Update headers to 1.0.28.
    ([!1900](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1900))
  ...
  - ext/openxr: Bump OpenXR headers to 1.0.34
    ([!2148](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2148))
  - external: Update android-jni-wrap, add additional wrapped methods.
    ([!1939](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1939),
    [!1963](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1963),
    [!2176](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2176))
  ...
  - gui: Use a single imgui.ini file from the config directory
    ([!1290](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1290))
  - imgui: Add ImPlot demo window.
    ([!692](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/692))
  - m/vec2: Add float array helper
    ([!1928](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1928))
  - m/vec3: Add float array helper
    ([!1928](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1928))
  - scripts: Add Include-What-You-Use (IWYU) helper scripts.
    ([!1229](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1229))
  ...
  - t/cli: Add new `info` command that prints information about the system, this is
    for end-user reports of failures to start `VRuska Engine-service`.
    ([!2094](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2094))
  ...
  - t/common: Add support for new dynamic device roles.
    ([!1992](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1992),
    [!1992](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1992),
    [!1999](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1999),
    [#296](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/issues/296),
    [!2020](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2020))
  ...
  - t/ctl: Support recentering of local spaces.
    ([!2055](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2055))
  - t/libVRuska Engine: Add support for dynamic device roles.
    ([!2013](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2013))
  - t/libVRuska Engine: Support recentering of local spaces.
    ([!2055](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2055))
  - t/libVRuska Engine: Support getting serial number from the device.
    ([!2099](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2099))
  ...
  - t/service-lib: Increase the duration of the starting timeout for the IPC.
    ([!2015](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2015))
- Misc. Fixes
  - Allow OpenGL to be found on \*nix without requiring GLX, which should allow
    a Wayland-only build.
    ([!963](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/963),
    [#132](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/issues/132))
  - Ensure we are always initializing our mutexes.
    ([!737](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/737))
  - Fix build issue with Wayland on some distributions.
    ([!1396](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1396),
    [#175](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/issues/175))
  - Fix several minor bindings and input profile issues.
    ([!2190](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2190))
  ...
  - Update vendored Catch2 to 2.13.10 to fix build issue.
    ([!1561](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1561),
    [#221](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/issues/221))
  - Update outdated URLs, email addresses, and names.
    ([!2041](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2041))
  - Update gitignore to exclude files intentionally in the repo.
    ([!2137](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2137),
    [#261](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/issues/261))
  - Various small warning fixes all over the codebase.
    ([!1869](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1869),
    [!2126](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2126))
  - Various spelling fixes all over the codebase.
    ([!1871](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1871))
  - build: Removed incorrect hidapi dependency from Rift S driver
    ([!2227](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2227))
  - ci: Miscellaneous fixes, improvements, and updates.
    ([!1886](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1886),
    [!2029](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2029),
    [!2031](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2031),
    [!2122](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2122),
    [!2181](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2181),
    [!2196](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2196),
    [!2197](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2197))
  - ci: use proclamation 2.0.0
    ([!2123](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2123))
  ...
  - cmake: Build system will now error out, rather than silently disable the
    ...
    ([!1262](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1262))
  ...
  - cmake: Handle multiple include of compiler flags.
    ([!1882](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1882))
  - cmake: Fix GetGitRevisionDescription cmake module for MSys
    ([!1944](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1944))
  ...
  - cmake: Update CMake modules from upstream repositories.
    ([!2040](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2040),
    [!2041](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2041),
    [!2045](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2045))
  - cmake: add wayland-client include directory to comp_main target
    ([!2141](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2141))
  - d/twrap: Correct axis assignments for poses provided by basalt VIO/SLAM, so
    they match the OpenXR axis definition.
    ([!2228](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2228))
  - ext/oxr: Add missing headers for unpublished VRuska Engine extensions:
  ...
  - jnipp: Update/patch to fix issues, including crashes.
    ([!2200](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2200),
    [!2226](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2226))
  - misc: Various NFC format fixes and a removal of unused define.
    ([!1946](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1946))
  ...
  - t/android_common: Specify mutability flag for PendingIntent object, required
    ...
    ([!1948](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1948))
  ...
  - t/common: Fix building the Lighthouse builder without the Vive driver.
    ([!1922](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1922))
  ...
  - t/north_star: In the North Star builder, add the SLAM device after
    the HMD device to avoid VRuska Engine-service crash due to misordering.
    ([!2228](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2228))
  - t/sdl_test: Compile as UTF-8 to fix MSVC warning.
    ([!1816](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1816))
  - t/sdl_test: sdl-test needs OpenGL4.5
    ([!1945](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/1945))
  - vcpkg: Remove SDL "base" feature. It has been removed upstream, see
    ...
    3b8fe445).
    VRuska Engine builds on Windows and the debug gui works (`XRT_DEBUG_GUI=1`).
    ([!2065](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/2065))

## VRuska Engine 21.0.0 (2021-01-28)

- Major changes
  - Adds a initial SteamVR driver state tracker and target that produces a SteamVR
    plugin that enables any VRuska Engine hardware driver to be used in SteamVR. This is
    ...
    ([!583](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/583))
- XRT Interface
  - Add `xrt_binding_profile` struct, related pair structs and fields on
    ...
    ([!587](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/587))
  - xrt: Generate bindings for VRuska Engine and SteamVR from json.
    ([!638](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/638))
  - xrt: Introduce `xrt_system_compositor`, it is basically a analogous to
    ...
    ([!652](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/652))
  - Expose more information on the frameservers, like product, manufacturer and
    serial.
    ([!665](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/665))
  - Add `XRT_FORMAT_BAYER_GR8` format.
    ([!665](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/665))
- State Trackers
  - st/oxr: Add OXR_FRAME_TIMING_SPEW for basic frame timing debug output.
    ([!591](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/591))
  - OpenXR: Make sure to restore old EGL display/context/drawables when creating a
    client EGL compositor.
    ([!602](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/602))
  - GUI: Expand with support for controlling the remote driver hand tracking.
    ([!604](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/604))
  - st/oxr: Implement XR_KHR_vulkan_enable2
    ([!633](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/633))
  - st/oxr: Add OXR_TRACKING_ORIGIN_OFFSET_{X,Y,Z} env variables as a quick way to
    tweak 6dof tracking origins.
    ([!634](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/634))
  - OpenXR: Be more relaxed with Quat validation, spec says within 1% of unit
    length, normalize if not within float epsilon.
    ([!659](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/659))
- Drivers
  - ns: Fix memory leak in math code.
    ([!564](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/564))
  - psvr: Rename some variables for better readability.
    ([!597](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/597))
  - openhmd: Fix viewport calculation of rotated displays.
    ([!600](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/600))
  ...
  - android: Acquire device display metrics from system.
    ([!611](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/611))
  - openhmd: Rotate DK2 display correctly.
    ([!628](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/628))
  - d/psmv: The motor on zcmv1 does not rumble at amplitudes < 0.25. Linear rescale
    amplitude into [0.25, 1] range.
    ([!636](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/636))
...
- IPC
  - ipc: Port IPC to u_logging.
    ([!601](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/601))
  - ipc: Make OXR_DEBUG_GUI work with VRuska Engine-service.
    ([!622](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/622))
- Compositor
  ...
  - main: Refactor how the compositor interacts with targets, the goal is to enable
    ...
    ([!599](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/599))
  - Implement support for XR_KHR_composition_layer_equirect (equirect1).
    ([!620](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/620),
    [!624](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/624))
  - comp: Improve thread safety. Resolve issues in multithreading CTS.
    ([!645](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/645))
  - main: Lower priority on sRGB format. This works around a bug in the OpenXR CTS
    ...
    ([!671](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/671))
- Helper Libraries
  ...
  - math: Make sure that we do not drop and positions in poses when the other pose
    ...
    ([!603](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/603))
  - aux/vk: `vk_create_device` now takes in a list of Vulkan device extensions.
    ([!605](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/605))
  - Port everything to u_logging.
    ([!627](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/627))
  - u/hand_tracking: Tweak finger curl model making it easier to grip ingame
    objects.
    ([!635](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/635))
  ...
  - u/distortion: Improve both Vive and Index distortion by fixing polynomial math.
    ([!666](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/666))
  - u/distortion: Improve Index distortion and tidy code. While this touches the
    ...
    ([!667](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/667))
- Misc. Features
  - Work toward a Win32 port.
    ([!551](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/551),
    [!605](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/605),
    [!607](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/607))
  - Additional improvements to the Android port.
    ([!592](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/592),
    [!595](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/595),
    [#105](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/issues/105))
- Misc. Fixes
  - steamvr: Support HMDs with rotated displays
    ([!600](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/600))

## VRuska Engine 0.4.1 (2020-11-04)
...
- State Trackers
  - st/oxr: Fix for new conformance tests for xrWaitFrame, xrBeginFrame,
    ...
    ([!589](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/589),
    [!590](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/590))

## VRuska Engine 0.4.0 (2020-11-02)

- XRT Interface
  - add `xrt_device_type` to `xrt_device` to differentiate handed controllers
    from
    controllers that can be held in either hand.
    ([!412](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/412))
  - Rename functions and types that assumed the native graphics buffer handle type
    ...
    ([!426](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/426),
    [!428](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/428))
  - Make some fields on `xrt_gl_swapchain` and `xrt_vk_swapchain` private moving
    ...
    ([!444](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/444))
  ...
  - Make `xrt_swapchain_create_flags` swapchain static image bit match OpenXR.
    ([!454](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/454))
  - Add `XRT_SWAPCHAIN_USAGE_INPUT_ATTACHMENT` flag to `xrt_swapchain_usage_bits`
    ...
    attachment.
    ([!459](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/459))
  - Remove the `flip_y` parameter to the creation of the native compositor, this
    is
    now a per layer thing.
    ([!461](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/461))
  ...
  - Add defines for underlying handle types.
    ([!469](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/469))
  ...
  - Add a whole bunch of structs and functions for all of the different layers
    ...
    ([!476](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/476))
  - Add `xrt_image_native_allocator` as a friend to the compositor interface. This
    ...
    ([!478](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/478))
  - Re-arrange and document `xrt_image_native`, making the `size` field optional.
    ([!493](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/493))
  - Add const to all compositor arguments that are info structs, making the
    ...
    ([!501](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/501))
  - Add `xrt_space_graph` struct for calculating space relations. This struct and
    ...
    to use
    these new functions.
    ([!519](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/519))
  ...
  - Remove the `out_timestamp` argument to the `xrt_device::get_tracked_pose`
    ...
    ([!521](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/521))
  - Replace mesh generator with `compute_distortion` function on `xrt_device`. This
    ...
    provided in util.
    ([!536](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/536))
  - Add a simple curl value based finger tracking model and use it for vive and
    survive controllers.
    ([!555](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/555))
- State Trackers
  - OpenXR: Add support for attaching Quad layers to action sapces.
    ([!437](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/437))
  - OpenXR: Use initial head pose as origin for local space.
    ([!443](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/443))
  - OpenXR: Minor fixes for various bits of code: copy-typo in device assignment
    ...
    ([!448](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/448))
  ...
  - OpenXR: Centralize all sub-action path iteration in some x-macros.
    ([!449](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/449),
    [!456](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/456))
  - OpenXR: Improve the validation in the API function for
    `xrGetInputSourceLocalizedName`.
    ([!451](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/451))
  ...
  - OpenXR: Properly handle more than one input source being bound to the same
    ...
    ([!452](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/452))
  ...
  - OpenXR: Implement action set priorities and fix remaining action conformance
    tests.
    ([!462](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/462))
  - st/oxr: Fix crash when calling `xrPollEvents` when headless mode is selected.
    ([!475](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/475))
  ...
  - OpenXR: Be sure to return `XR_ERROR_FEATURE_UNSUPPORTED` if the protected
    ...
    ([!481](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/481))
  - OpenXR: Update to 1.0.11 and start returning the new
    ...
    ([!482](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/482))
  - OpenXR: Enable the `XR_KHR_android_create_instance` extension.
    ([!492](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/492))
  - OpenXR: Add support for creating swapchains with depth formats and submitting
    ...
    not used yet.
    ([!498](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/498))
  - OpenXR: For pose actions the any path (`XR_NULL_PATH`) needs to be special
    ...
    at
    binding time.
    ([!510](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/510))
  - OpenXR: More correctly implement `xrGetInputSourceLocalizedName` allowing apps
    ...
    ([!532](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/532))
  - OpenXR: Pass through equirect layer data to the compositor.
    ([!566](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/566))
- Drivers
  - psvr: We were sending in the wrong type of time to the 3DOF fusion code,
    switch
    to nanoseconds instead of fractions of seconds.
    ([!474](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/474))
  - rs: Make the pose getting from the T265 be threaded. Before we where getting
    ...
    ([!486](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/486))
  - survive: Add lighthouse tracking system type
    hydra: Add lighthouse tracking
    system type
    ([!489](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/489))
  - rs: Add slam tracking system type
    northstar: Use tracking system from tracker
    (e.g. rs) if available.
    ([!494](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/494))
  - psmv: Introduce proper grip and aim poses, correctly rotate the grip pose to
    ...
    ([!509](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/509))
  - survive: Implement haptic feedback.
    ([!557](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/557))
  - simulated: Tidy the code a bit and switch over to the new
    logging API.
    ([!572](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/572),
    [!573](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/573))
  - psvr: Switch to the new logging API.
    ([!573](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/573))
  - Add initial "Cardboard" phone-holder driver for Android.
    ([!581](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/581))
- IPC
  - Generalize handling of native-platform handles in IPC code, allow bi-
    ...
    ([!413](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/413),
    [!427](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/427))
  ...
  - ipc: Allow sending zero handles as a reply, at least the Linux fd handling code
    allows this.
    ([!491](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/491))
  - Use a native AHardwareBuffer allocator on the client side when building for
    recent-enough Android.
    ([!493](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/493))
  - ipc: Add functionality to disable a device input via the `VRuska Engine-ctl` utility,
    this allows us to pass the conformance tests that requires the runtime to turn
    off a device.
    ([!511](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/511))
- Compositor
  - compositor: Add support for alpha blending with premultiplied alpha.
    ([!425](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/425))
  - compositor: Implement subimage rectangle rendering for quad layers.
    ([!433](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/433))
  - compositor: Enable subimage rectangle rendering for projection layers.
    ([!436](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/436))
  - compositor: Fix printing of current connected displays on nvidia when no
    allowed display is found.
    ([!477](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/477))
  ...
  - compositor and clients: Use a generic typedef to represent the platform-
    ...
    ([!479](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/479))
  ...
  - compositor: Implement cylinder layers.
    ([!495](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/495))
  ...
  - main: Add code to check that a format is supported by the GPU before exposing.
    ([!502](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/502))
  - compositor: Remove panotools and vive shaders from compositor.
    ([!538](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/538))
  - Initial work on a port of the compositor to Android.
    ([!547](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/547))
  - render: Implement equirect layer rendering.
    ([!566](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/566))
  - main: Fix leaks of sampler objects that was introduced in !566.
    ([!571](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/571))
- Helper Libraries
  ...
  - util: Tidy hand tracking header.
    ([!574](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/574))
  - math: Fix doxygen warnings in vector headers.
    ([!574](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/574))
- Misc. Features
  - Support building in-process VRuska Engine with meson.
    ([!421](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/421))
  - Allow building some components without Vulkan. Vulkan is still required for the
    ...
    ([!429](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/429))
...
## VRuska Engine 0.3.0 (2020-07-10)

- Major changes
  - Centralise the logging functionality in VRuska Engine to a single util helper.
    ...
    ([!408](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/408),
    [!409](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/409))
- XRT Interface
  - compositor: Remove the `array_size` field from the struct, this was the only
    ...
    ([!359](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/359))
  - Improve Doxygen documentation of interfaces. Now the inheritance structure and
    ...
    developers understand the internal structure of VRuska Engine better.
    ([!365](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/365),
    [!367](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/367))
  - xrt: Add xrt_result_t return type to many compositor functions that previously
    had no way to indicate failure.
    ([!369](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/369))
  - compositor: Introduce `xrt_swapchain_create_info` simplifying the argument
    ...
    ([!407](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/407))
- State Trackers
  - OpenXR: Update headers to 1.0.9.
    ([!358](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/358))
  ...
  - OpenXR: Track the name and localized name for both actions and action sets,
    ...
    spec. ([!359](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/359))
  ...
  - OpenXR: Where used make sure we verify the view configuration type is a valid
    ...
    ([!368](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/368))
  - OpenXR: More correctly verify the interactive profile binding data, including
    ...
    ([!377](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/377))
  - OpenXR: Transform input types in a somewhat flexible, composable way. Also, do
    ...
    ([!379](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/379))
  - OpenXR: Tidy the extensions generated by the script and order them according
    ...
    ([!410](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/410))
  - OpenXR: Fix overly attached action sets, which would appear to be attached to
    ...
    ([!411](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/411))
- Drivers
  ...
  - vive: Create vive_config module to isolate config code and avoid duplication
    ...
    interface.
    vive: Fix a bug where using the Vive Pro crashed VRuska Engine.
    vive: Fix a
    bug where the controller didn't parse JSON vectors correctly.
    vive: Move
    missing functions to and use u_json.
    ([!405](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/405))
  - vive: Add support for Gen1 and Gen2 Vive Trackers.
    ([!406](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/406))
  - vive: Port to new u_logging API.
    ([!417](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/417))
  - comp: Set a compositor window title.
    ([!418](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/418))
- IPC
...
- Compositor
  ...
  - main: We were alpha blending all layers previously, but now we support the
    ...
    ([!394](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/394))
...
- Misc. Features
  - build: Allow enabling inter-procedural optimization in CMake GUIs, if supported
    ...
    ([!330](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/330))
- Misc. Fixes
  - No significant changes

## VRuska Engine 0.2 (2020-05-29)

- Major changes
  - Add support for a new service process. This process houses the hardware drivers
    and compositor. In order to do this, a whole new subsection of VRuska Engine called
    ipc
    was added. It lives in `src/xrt/ipc` and sits between the state trackers
    and
    the service hosting the drivers and compositor.
    ([!295](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/295))
  - Support optional systemd socket-activation: if not disabled at configure time,
    `VRuska Engine-service` can be launched by systemd as a service with an associated
    ...
    also included.
    ([!306](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/306))
- XRT Interface
  - Add a new settings interface for transporting camera settings, in
    `xrt/xrt_settings.h`.
    ([!266](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/266))
  ...
  - Added new `xrt_instance` object to be root object, a singleton that allows us
    ...
    ([!274](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/274))
  - Remove the `struct timestate` argument from the `struct xrt_device` interface.
    ...
    compositor work.
    ([!280](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/280))
  - Add the new format `XRT_FORMAT_UYVY422` to the interface and various parts of
    ...
    ([!283](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/283))
  - Expose manufacturer and serial number in the prober interface, right now only
    ...
    ([!286](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/286))
  - Add `XRT_CAST_PTR_TO_OXR_HANDLE` and `XRT_CAST_OXR_HANDLE_TO_PTR` macros to
    ...
    ([!294](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/294))
  - Remove declaration and implementations of `xrt_prober_create`: the minimal
    ...
    `xrt_instance_create`.
    ([!347](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/347))
- State Trackers
  - gui: Fix compilation issue in `st/gui` when building without OpenCV.
    ([#63](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/issues/63),
    [!256](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/256))
  - OpenXR: Don't return struct with invalid type from
    `xrEnumerateViewConfigurationViews`.
    ([!234](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/234))
  - prober: Print more information from the prober when spewing.
    ([!261](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/261))
  ...
  - gui: Fix name not being shown when video device does not have any modes.
    ([!269](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/269))
  - gui: Remove old video test scene, never used and seemed to be broken.
    ([!275](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/275))
  - gui: Fix build when OpenCV is not available or disabled.
    ([!292](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/292))
  ...
  - OpenXR: Validate that we support the given `XR_ENVIRONMENT_BLEND_MODE` as
    ...
    ([!345](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/345))
  ...
  - OpenXR: Validate time better in xrConvertTimeToTimespecTimeKHR and add better
    error print.
    ([!348](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/348))
  - OpenXR: Correctly translate the `XrSwapchainCreateFlags` flags to xrt ones.
    ([!349](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/349))
  ...
  - OpenXR: Give better error messages on invalid poses in quad layers instead of
    ...
    ([!350](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/350))
  - OpenXR: Validate poses for project layer views, using the same expressive error
    messages as the quad layers.
    ([!350](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/350))
  - OpenXR: Translate the swapchain usage bits from OpenXR enums to VRuska Engine's
    internal enums.
    ([!350](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/350))
  - OpenXR: Report a spec following amount of maximum layers supported.
    ([!354](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/354))
  ...
  - OpenXR: Correctly handle the space relation flag bits, some old hacked up code
    left over since VRuska Engine's first days have been removed.
    ([!356](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/356))
- Drivers
  - dd: Add a driver for the Google Daydream View controller.
    ([!242](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/242))
  - all: Use new pre-filter and 3-DoF filter in drivers.
    ([!249](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/249))
  - arduino: Added a Arduino based flexible input device driver, along with
    Arduino C++ code for it.
    ([!251](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/251))
  - psmv: Use all 6 measurements to compute acceleration bias, and port to new
    IMU prefilter.
    ([!255](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/255))
  ...
  - vive: Add basic 3DOF driver for Vive Wand Controller with full input support
    ...
    ([!281](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/281))
  - psvr: Use a better 3dof fusion for the PSVR when no tracking is available.
    ([!282](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/282))
  - psvm: Move the led and rumble updating from the application facing
    update_inputs
    function to the internal thread instead.
    ([!287](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/287))
  - psmv: Fix failure to build from source on PPC.
    ([!288](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/288),
    [#69](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/issues/69))
- Compositor
  - main: Fix XCB memory leaks and correctly use XCB/Xlib interop.
    ([!257](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/257))
  - main: Shorten Vulkan initializers.
    ([!259](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/259))
  - main: Port XCB and direct mode back ends to plain C.
    ([!262](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/262))
  - main: Add support for Vive Pro, Valve Index, Oculus DK1, DK2 and CV1 to NVIDIA
    direct mode.
    ([!263](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/263))
  - client: Make sure that the number of images is decided by the fd compositor.
    ([!270](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/270))
  - main: Split RandR and NVIDIA direct mode window back ends.
    ([!271](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/271))
  - main: Improve synchronization and remove redundant vkDeviceWaitIdle calls.
    ([!277](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/277))
  - main: Delay the destruction of swapchains until a time where it is safe, this
    ...
    ([!278](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/278))
  - client: Propagate the supported formats from the real compositor to the client
    ones. ([!282](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/282))
  - renderer: Change the idle images colour from bright white to grey.
    ([!282](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/282))
  - main: Add support for multiple projection layers.
    ([!340](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/340))
...
- Misc. Features
  - build: Refactor CMake build system to make static (not object) libraries and
    ...
    ([!233](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/233),
    [!237](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/237),
    [!238](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/238),
    [!240](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/240))
  ...
  - tracking: Make stereo_camera_calibration reference counted, and have the
    ...
    ([!245](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/245))
  ...
  - math: Add pre-filter and a simple understandable 3-DoF fusion filter.
    ([!249](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/249))
  - build: Enable the build system to install `VRuska Engine-cli` and `VRuska Engine-gui`.
    ([!252](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/252))
  ...
  - build: Support building with system cJSON instead of bundled copy.
    ([!284](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/284),
    [#62](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/issues/62))
...
- Misc. Fixes
  - os/ble: Check if `org.bluez` name is available before calling in
    `os/os_ble_dbus.c`.
    ([#65](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/issues/65),
    [#64](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/issues/64),
    [!265](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/265))
  - README: Added information to the README containing OpenHMD version requirement
    ...
    limitations on VRuska Engine's compositor.
    ([!4](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/4))
  - build: Fix build issues and build warnings when 32-bit.
    ([!230](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/230))
  - os/ble: Fix crash due to bad dbus path, triggered by bad return checking when
    probing for BLE devices.
    ([!247](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/247))
  - d/dd: Use the correct time delta in DayDream driver.
    ([!249](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/249))
  - doc: Stop changelog snippets from showing up in 'Related Pages'
    ([!253](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/253))
  - build: Fix meson warnings, increase compiler warning level.
    ([!258](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/258))
  - os/ble: Fix leak in `os/os_ble_dbus.c` code when failing to find any device.
    ([!264](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/264))
  ...
  - u/hashset: Fix warnings in `util/u_hashset.h` after pedantic warnings were
    enabled for C++.
    ([!268](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/268))
  ...
  - windows: Way way back when Gallium was made `auxiliary` was named `aux` but
    ...
    and so we find ourselves with the same problem. Although VRuska Engine inherited
    the correct name, the same old mistake was made in docs.
    ([!314](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/314))
  - build: For CMake rename (nearly) all build options so they begin with `XRT_`
    ...
    ([!327](https://gitlab.freedesktop.org/VRuska Engine/VRuska Engine/merge_requests/327))
...
## VRuska Engine 0.1.0 (2020-02-24)
